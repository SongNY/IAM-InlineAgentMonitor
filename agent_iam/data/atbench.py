"""
ATBench loader → IAM canonical Trajectory schema.
...
We map ATBench's enum strings to IAM's enums where possible and fall
...
def load_atbench(split: str = "test", subset: str = "ATBench") -> Iterator[Trajectory]:
    """Yield IAM `Trajectory` objects from ATBench.
