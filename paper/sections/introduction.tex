...
We present \textbf{IAM}, a sub-2B online trajectory monitor that fills
...
(Section~\ref{sec:experiments}, F1). IAM's value is for the substantial
...
and position IAM as a runtime layer that complements alignment for the
weakly-aligned regime rather than substituting for it.

On a preliminary 269-trace evaluation set, IAM prevents
