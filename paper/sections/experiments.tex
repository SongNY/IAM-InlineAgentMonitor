...
\begin{table}[t]
  ...
  \begin{tabular}{lccc}
    ...
    \textbf{TraceGuard (verdict head)} & $\mathbf{\approx 0.89}$ & $\mathbf{\approx 0.95\text{--}1.0}$ & $\mathbf{\approx 0.997}$ \\
    \bottomrule
  \end{tabular}
...
$P(\textsc{STOP})$ threshold $\tau\approx 0.92$, TraceGuard reaches
...
\begin{itemize}[leftmargin=1.4em,itemsep=0.15em]
  ...
  \item \textbf{F8 --- Attack success is 2D.} Attack success is governed jointly
        ...
        TraceGuard targets the weakly-aligned cell of this matrix.
\end{itemize}
